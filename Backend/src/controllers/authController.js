...
const buildAuthResponse = (accessToken, refreshToken, user, organization, extra = {}) => ({
  ...
  organization: {
    ...
    subIndustry: organization.subIndustry || null,
    logoUrl: organization.logoUrl || null,
    faviconUrl: organization.faviconUrl || null,
    website: organization.website || null,
    brandColor: organization.brandColor || '#f0512f',
  },
  ...extra,
});
  ...
  try {
    ...
    const [org] = await Organization.create(
      [{
        ...
        subIndustry: req.body.subIndustry ? req.body.subIndustry.trim() : null,
        logoUrl: req.body.logoUrl ? req.body.logoUrl.trim() : null,
        faviconUrl: req.body.faviconUrl ? req.body.faviconUrl.trim() : null,
        website: req.body.website ? req.body.website.trim() : null,
        brandColor: req.body.brandColor || '#f0512f',
