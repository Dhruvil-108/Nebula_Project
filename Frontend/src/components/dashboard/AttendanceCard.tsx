...
export const AttendanceCardSkeleton: React.FC = () => (
  <div className="p-6 rounded-2xl bg-white border border-slate-200 space-y-5 animate-pulse shadow-sm">
    <div className="flex items-center justify-between">
      <div className="w-28 h-4 rounded bg-slate-100" />
      <div className="w-24 h-6 rounded-full bg-slate-100" />
    </div>
    <div className="space-y-2">
      <div className="w-48 h-10 rounded-lg bg-slate-100" />
...
export const AttendanceCard: React.FC = () => {
  ...
  return (
    <motion.div
      ...
      className={clsx(
        'relative overflow-hidden p-6 rounded-2xl border transition-all duration-300 shadow-sm flex flex-col justify-between bg-white',
        isCheckedIn && 'border-emerald-300 ring-1 ring-emerald-200',
        isOnBreak && 'border-amber-300 ring-1 ring-amber-200',
        isCheckedOut && 'border-slate-200',
        isNotCheckedIn && 'border-slate-200 hover:border-slate-300'
      )}
    >
      ...
      <div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-100 mb-5 flex items-center justify-between">
          <div>
            <p className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Total Worked Today</p>
            <p className="text-lg font-mono font-bold text-slate-900 tracking-wide mt-0.5">
      ...
      <div className="space-y-2.5">
        ...
        {isNotCheckedIn && (
          <button
            ...
            className="w-full py-3 px-4 rounded-xl font-semibold text-sm bg-[#f97316] text-white hover:bg-[#ea580c] active:scale-[0.99] transition-all duration-200 shadow-lg shadow-[#f97316]/25 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            ...
            {isCheckedIn ? (
              <button
                ...
                disabled={isPendingMutation}
                className="py-2.5 px-3 rounded-xl font-medium text-xs bg-[#fff7ed] text-[#ea580c] border border-[#fed7aa] hover:bg-[#ffedd5] active:scale-[0.98] transition-all flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-50"
              >
            ...
            <button
              ...
              className="py-2.5 px-3 rounded-xl font-medium text-xs bg-[#fff7ed] text-[#ea580c] border border-[#fed7aa] hover:bg-[#ffedd5] active:scale-[0.98] transition-all flex items-center justify-center gap-1.5 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            >
        ...
        {isCheckedOut && (
          <div className="py-2.5 px-4 rounded-xl bg-[#fff7ed] border border-[#fed7aa] text-center">
            <p className="text-xs text-[#ea580c] font-medium flex items-center justify-center gap-1.5">
