        ...
        <div className="flex items-center gap-2">
          {isManagement && (
            <select
              ...
              className="rounded-lg border border-[#ECE0D6] bg-white px-3 py-2 text-sm text-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-[#C2540C]/25 focus:border-[#C2540C] transition-all sm:w-56"
            >
                ...
                (documents || []).map((doc, idx) => (
                  ...
                  >
                    <td className="px-5 py-3.5">
                      <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-[#FBEAE0] text-[#7A2F05] text-xs font-semibold">
                    ...
                    <td className="px-5 py-3.5">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="font-medium text-[#C2540C] hover:underline inline-flex items-center gap-1.5"
                      >
                        {doc.fileName}
